...
def instructions():
    print(make_statement("Instructions", "ℹ"))
...
The program will record the ticket sale and calculate the ticket cost (and the profit). Once you have either sold all 
of the tickets or entered the exit code ('xxx'), the program will display the ticket sales information and write the 
data to a text file. 
...
# Loop to get nane, age and payment details
...
adjusted_explanation = (f"We have given away a ticket worth ${ticket_won:.2f} which "
                        f"means our sales have decreased by 4{ticket_won:.2f} and our"
                        f"profit decreased by ${profit_won:.2f}.")

# winner announcement
lucky_winner_string = (f"The lucky winner is {winner}. "
                       f"Their ticket is worth ${ticket_won:.2f} is free!")
final_total_paid_string = f"Total Paid is now ${total_paid - ticket_won:.2f}"
final_profit_string = f"Total Profit is now ${total_profit - ticket_won:.2f}"
